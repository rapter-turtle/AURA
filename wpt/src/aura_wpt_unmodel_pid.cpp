...
public:
    ActuatorPublisher()
        : Node("actuator_publisher"),
          ...
          acceptance_radius(3.0), Kp(0.0), Kd(0.0), Kup(140.0), Kud(200.0), Kui(10), max_I(1),
...
private:
    ...
    void timer_callback()
    {
        ...
        if (!waypoints.empty())
        {
            ...
            double proposed_thrust = (5.0 * desired_velocity + Xu * u - Kup * velocity_e - Kud * (velocity_e - before_velocity_e) - Kui * I_thrust);  // Thrust calculation
