...
class ShipSimulator(Node):
    def __init__(self):
        ...
        self.ship_state[2] = 3.141592 * 0.0  # Heading (orientation)
        self.control_input = np.zeros(3)  # [n1, n2]
    ...
    def control_callback(self, msg):
        ...
        self.control_input[0] = msg.data[0]  # Steer
        self.control_input[1] = msg.data[1]  # Thrust
        self.control_input[2] = msg.data[2]  
    ...
    def recover_simulator(self, ship, control_input, dt):
        ...
        thrust, steer, bow = control_input[1], control_input[0], control_input[2]
        eps = 1e-5
