...
public:
    ActuatorPublisher()
        : Node("actuator_publisher"),
          ...
          acceptance_radius(8.0), Kp(0.0), Kd(0.0), Kup(100.0), Kud(0.0), Kui(40), max_I(1),
          desired_velocity(0.0), max_steer(100), max_thrust(70), max_thrust_diff(0.5), max_steer_diff(0.5)
    {
...
private:
    ...
    void timer_callback()
    {
        ...
        if (!waypoints.empty())
        {
            ...
            double proposed_thrust = ( - Kup * velocity_e - Kud * (velocity_e - before_velocity_e) - Kui * I_thrust);  // Thrust calculation
